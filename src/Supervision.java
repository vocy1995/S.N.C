...
public class Supervision extends JFrame {
   ...
   public void Employ_run(){
      ...
      p.setLayout(null);
         try{
        	 client.ClientRun("supervision");
             
             String receiveData = "";
             receiveData = client.br.readLine();
             System.out.println("제목 받은것 : "+receiveData);   
             String employ[] = receiveData.split("!!!");
             System.out.println("자른것 : "+employ[0]);
             for(int count=0;count<employ.length;count++) {
                title[count]=employ[count];
                System.out.println("자른것 : "+employ[count]);
      ...
      j2.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e4) {
            Supervision_Content t=new Supervision_Content();
            t.Get_Content_Count=1;
            t.Employ_Content_run();
         }
      });
