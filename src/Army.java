...
public class Army extends JFrame {
	...
	public void Army_run(){
		 ...
		 String title[] = new String[50];
	      ...
	      p.setLayout(null);
	         try{
	            client.ClientRun("army");
	             
	             String receiveData = "";
	             receiveData = client.br.readLine();
	             System.out.println("제목 받은것 : "+receiveData);   
	             String Army[] = receiveData.split("!!!");
	             System.out.println("자른것 : "+Army[0]);
	             for(int count=0;count<Army.length;count++) {
	                title[count]=Army[count];
	                System.out.println("자른것 : "+Army[count]);
	     ...
	     j2.setFont(new Font("메이플스토리", Font.BOLD, 35));
	      ...
	      j2.addActionListener(new ActionListener() {
	         ...
	         public void actionPerformed(ActionEvent e4) {
	            Army_Content t=new Army_Content();
