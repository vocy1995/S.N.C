...
public class Engineering extends JFrame {
	...
	public void Engineering_run(){
		...
		p.setLayout(null);
			try{
				client.ClientRun("engineering");
		    	
		    	String receiveData = "";
		    	receiveData = client.br.readLine();
		    	System.out.println("제목 받은것 : "+receiveData);	
		    	String Engineering_split[] = receiveData.split("!!!");
		...
		j2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e4) {
				Engineering_Content t=new Engineering_Content();
				t.Get_Content_Count=1;
				t.Engineering_Content_run();
			}
		});
